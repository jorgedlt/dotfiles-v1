...
# add a mac OS detect feature
[[ "$OSTYPE" == "darwin"* ]] && {
        # Mac OSX
} || {
  echo "Not a MACOSX system, brew cannot be installed"
  exit 0;
}

#
[ -f "/usr/local/bin/brew" ] && : || {
  echo "Brew Not, Installing Now"
...
# This can also be done in iTERM2 (IMHO safer)
...
# sshpass - Can not be done via brew - http://www.hashbangcode.com/blog/installing-sshpass-osx-mavericks
#
